...
import org.rahul.streams.advanced.BuildingStreams;
...
public class PrintFileContent {
    ...
    public static void main(String[] args) throws IOException {
        String content=processFile("/../../../../netbeans/LICENSE.txt", new FileProcessor() {
        ...
        String oneline=processFile("/../../../../netbeans/LICENSE.txt",br->(br.readLine()));
        System.out.println("oneline:"+oneline);
        String fourlines=processFile("/../../../../netbeans/LICENSE.txt",br->(br.readLine()+br.readLine()+br.readLine()+br.readLine()));
